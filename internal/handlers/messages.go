...
func (a *App) SendOutgoingMessage(ctx context.Context, req OutgoingMessageRequest, opts MessageSendOptions) (*models.Message, error) {
	...
	sendFn := func(sendCtx context.Context) (string, error) {
		...
		case models.MessageTypeText:
			return a.WhatsApp.SendTextMessage(sendCtx, req.Account, req.Contact.PhoneNumber, req.Content, replyToMsgID)
		...
		case models.MessageTypeImage, models.MessageTypeVideo, models.MessageTypeAudio, models.MessageTypeDocument:
			...
			if mediaID == "" && len(req.MediaData) > 0 {
				var err error
				mediaID, err = a.WhatsApp.UploadMedia(sendCtx, req.Account, req.MediaData, req.MediaMimeType, req.MediaFilename)
				if err != nil {
			...
			case models.MessageTypeImage:
				return a.WhatsApp.SendImageMessage(sendCtx, req.Account, req.Contact.PhoneNumber, mediaID, req.Caption)
			case models.MessageTypeVideo:
				return a.WhatsApp.SendVideoMessage(sendCtx, req.Account, req.Contact.PhoneNumber, mediaID, req.Caption)
			case models.MessageTypeAudio:
				return a.WhatsApp.SendAudioMessage(sendCtx, req.Account, req.Contact.PhoneNumber, mediaID)
			default: // document
				return a.WhatsApp.SendDocumentMessage(sendCtx, req.Account, req.Contact.PhoneNumber, mediaID, req.MediaFilename, req.Caption)
			}

		case models.MessageTypeInteractive:
			switch req.InteractiveType {
			case "cta_url":
				return a.WhatsApp.SendCTAURLButton(sendCtx, req.Account, req.Contact.PhoneNumber, req.BodyText, req.ButtonText, req.URL)
			default: // "button" or "list"
				return a.WhatsApp.SendInteractiveButtons(sendCtx, req.Account, req.Contact.PhoneNumber, req.BodyText, req.Buttons)
			}
		...
		case models.MessageTypeTemplate:
			...
			return a.WhatsApp.SendTemplateMessage(sendCtx, req.Account, req.Contact.PhoneNumber, req.Template.Name, req.Template.Language, req.BodyParams)

		case models.MessageTypeFlow:
			if req.FlowID == "" {
				return "", fmt.Errorf("flow ID is required for flow messages")
			}
			return a.WhatsApp.SendFlowMessage(sendCtx, req.Account, req.Contact.PhoneNumber, req.FlowID, req.FlowHeader, req.BodyText, req.FlowCTA, req.FlowToken, req.FlowFirstScreen)
