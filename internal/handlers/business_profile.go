...
func (a *App) GetBusinessProfile(r *fastglue.Request) error {
        ...
        profile, err := a.WhatsApp.GetBusinessProfile(ctx, account)
        if err != nil {
...
func (a *App) UpdateBusinessProfile(r *fastglue.Request) error {
        ...
        if err := a.WhatsApp.UpdateBusinessProfile(ctx, account, input); err != nil {
...
func (a *App) UpdateProfilePicture(r *fastglue.Request) error {
        ...
        handle, err := a.WhatsApp.UploadProfilePicture(ctx, account, fileContent, fileHeader.Header.Get("Content-Type"))
        if err != nil {
        ...
        input := models.BusinessProfileInput{
                MessagingProduct:     "whatsapp",
                ProfilePictureHandle: handle,
        }

        err = a.WhatsApp.UpdateBusinessProfile(ctx, account, input)
