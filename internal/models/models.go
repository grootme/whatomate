...
type WhatsAppAccount struct {
        ...
        ClientType         string    `gorm:"size:20;default:'meta'" json:"client_type"`                 // meta, whatsmeow
        AppID              string    `gorm:"size:100" json:"app_id"`                                    // Meta App ID
        PhoneID            string    `gorm:"size:100" json:"phone_id"`                                  // Meta Phone ID or Whatsmeow JID
        BusinessID         string    `gorm:"size:100" json:"business_id"`                               // Meta Business ID
        AccessToken        string    `gorm:"type:text" json:"-"`                                        // encrypted Meta Access Token
        AppSecret          string    `gorm:"size:255" json:"-"`                                          // Meta App Secret
        ...
        BaseURL            string    `gorm:"size:255;default:'https://graph.facebook.com'" json:"base_url,omitempty"` // Meta Graph API base URL
        ...
        SessionData        JSONB     `gorm:"type:jsonb" json:"-"`       // encrypted session data for whatsmeow
        QRCode             string    `gorm:"type:text" json:"qr_code"` // Current QR code for pairing
