...
func (ae *AnalysisEngine) ComputeSentiment(content string) SentimentResult {
	...
	positiveWords := map[string]bool{
		...
		"bom": true, "excelente": true, "ótimo": true, "maravilhoso": true,
		"feliz": true, "obrigado": true, "perfeito": true, "incrível": true,
		"bon": true, "excellent": true, "merci": true, "superbe": true,
	}
	...
	negativeWords := map[string]bool{
		...
		"bad": true, "terrible": true, "horrible": true, "worst": true,
		"sad": true, "angry": true, "frustrated": true, "scam": true,
		"fraud": true, "danger": true, "death": true, "kill": true,
		"ruim": true, "terrível": true, "horrível": true, "triste": true,
		"mauvais": true, "terrible": true, "horrible": true, "triste": true,
		"colère": true, "arnaque": true, "fraude": true, "danger": true,
	}
