...
func (a *App) CreateAccount(r *fastglue.Request) error {
        ...
        // Set initial status based on client type
        // Meta accounts start as active (they use API tokens)
        // Whatsmeow accounts start as disconnected (need QR pairing)
        if clientType == whatsapp.WhatsmeowClientType {
