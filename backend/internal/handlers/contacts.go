                                ...
                                go func() {
                                        ...
                                        for _, msg := range unreadMessages {
                                                ...
                                                if msg.WhatsAppMessageID != "" {
                                                        if err := a.WhatsApp.MarkMessageRead(ctx, &account, msg.WhatsAppMessageID); err != nil {
...
func (a *App) sendWhatsAppReaction(account *models.WhatsAppAccount, contact *models.Contact, message *models.Message, emoji string) {
        ...
        ctx := context.Background()
        _, err := a.WhatsApp.SendReaction(ctx, account, contact.PhoneNumber, message.WhatsAppMessageID, emoji)
        if err != nil {
