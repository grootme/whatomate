...
func (a *App) CreateCatalog(r *fastglue.Request) error {
	...
	metaCatalogID, err := a.WhatsApp.CreateCatalog(ctx, &account, req.Name)
	if err != nil {
...
func (a *App) DeleteCatalog(r *fastglue.Request) error {
	...
	if err := a.WhatsApp.DeleteCatalog(ctx, &account, catalog.MetaCatalogID); err != nil {
...
func (a *App) SyncCatalogs(r *fastglue.Request) error {
	...
	metaCatalogs, err := a.WhatsApp.ListCatalogs(ctx, &account)
	if err != nil {
...
func (a *App) CreateCatalogProduct(r *fastglue.Request) error {
	...
	metaProductID, err := a.WhatsApp.CreateProduct(ctx, &account, catalog.MetaCatalogID, productInput)
	if err != nil {
...
func (a *App) UpdateCatalogProduct(r *fastglue.Request) error {
	...
	if err := a.WhatsApp.UpdateProduct(ctx, &account, product.MetaProductID, productInput); err != nil {
...
func (a *App) DeleteCatalogProduct(r *fastglue.Request) error {
	...
	if err := a.WhatsApp.DeleteProduct(ctx, &account, product.MetaProductID); err != nil {
