...
const server = app.listen(BRIDGE_PORT, '0.0.0.0', () => {
  console.log(`[sb-bridge] Shadowbroker AI Bridge running on http://0.0.0.0:${BRIDGE_PORT}`)
  ...
  console.log(`[sb-bridge] Real-Time Bundle: ${BUNDLE_URL}`)
  console.log(`[sb-bridge] AI Model: ${OPENROUTER_MODEL}`)
  console.log(`[sb-bridge] Database: ${DB_PATH}`)
  console.log(`[sb-bridge] Auto-pilot: starting automatically...`)

  // Auto-start autopilot mode
  startAutoPilot()
})
